...
__conda_setup="$('/home/flagmate/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/flagmate/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/flagmate/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/flagmate/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<

export PATH="$PATH:/home/flagmate/development/flutter/bin"

export PATH="$PATH:/home/flagmate/development/tools/bin/"

export PATH="$PATH:/home/flagmate/.local/bin"

export PATH="$PATH:~/.local/bin/"

export PATH="$PATH:/home/flagmate/kivy_venv/bin/activate"
...
alias config='vim ~/.bashrc' # Quick access to the ~/.zshrc file
